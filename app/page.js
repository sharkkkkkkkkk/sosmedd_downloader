...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col items-center p-4 sm:p-8 font-sans overflow-x-hidden">
      ...
      <main className="z-10 w-full max-w-lg flex flex-col items-center gap-6 mt-6 sm:mt-16">
        {/* Header */}
        <div className="text-center space-y-4">
          <div className="relative inline-flex items-center justify-center w-20 h-20 rounded-3xl bg-gradient-to-br from-card to-background border border-border shadow-2xl mb-4 group hover:scale-105 transition-transform duration-300">
        ...
        {/* Scrolling Marquee with Framer Motion & Simple Icons */}
        <div className="w-full max-w-sm overflow-hidden relative py-2 mb-2">
        ...
        {/* Promotion Section */}
        <div className="mt-12 mb-6 text-center z-10 animate-in fade-in slide-in-from-bottom-3">
